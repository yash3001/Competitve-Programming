...
ll bfs(ll curi,ll curj,ll n,ll m,vector<string> &v){
	...
	while(!q.empty()){
		...
		for(int k=0;k<4;k++){
			...
			if(newi>=0 && newi<n && newj>=0 && newj<m && v[newi][newj]!='#' && vis[newi][newj]==false){
